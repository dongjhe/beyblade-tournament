...
export class AppComponent {
 ...
 addBattleScore(side:'a'|'b',type:FinishType){if(!this.battleMatch||this.battleFinished)return;const add=this.finishPoints(type);if(side==='a')this.battleMatch.sa=(this.battleMatch.sa??0)+add;else this.battleMatch.sb=(this.battleMatch.sb??0)+add;this.battleRound++;this.resetLaunchFails();this.updateScore(this.battleMatch);}
